...
public class MovementManager : MonoBehaviour {
    ...
    [HideInInspector]
    public RedirectionManagerRDW redirectionManager;
    ...
    private void Awake()
    {
        ...
        redirectionManager = GetComponent<RedirectionManagerRDW>();
    ...
    public void LoadData(int avatarId, AvatarInfo avatar) {
        ...
        rm.redirectorChoice = RedirectionManagerRDW.RedirectorToRedirectorChoice(rm.redirectorType);
        rm.resetterChoice = RedirectionManagerRDW.ResetterToResetChoice(rm.resetterType);
    ...
    public void UpdateVisualizations() {
        ...
        for (int i = 0; i < otherAvatarRepresentations.Count; i++) {            
            ...
            var rm = us.GetComponent<RedirectionManagerRDW>();
